...
var getUser_1 = require("./middleware/getUser");
...
var cryptoService = new CryptoService_1.CryptoService();
var dbService = new DbService_1.DbService(config_1.config, cryptoService);
var sessionService = new SessionService_1.SessionService(utils_1.Utils, dbService);
var getUser = getUser_1.createGetUser(dbService, sessionService);
var userRouter = userRouter_1.createUserRouter(getUser, dbService);
var sessionRouter = sessionRouter_1.createSessionRouter(dbService, sessionService);
...
server.listen(app.get('port'), function () {
    console.log("Server started on " + config_1.config.port);
});
